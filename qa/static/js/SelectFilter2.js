...
window.SelectFilter = {
    init: function(field_id, field_name, is_stacked, admin_static_prefix) {
        ...
        var choose_all_wrap = quickElement('div', selector_available, "");
        choose_all_wrap.className = 'selector-choose-wrap';
        var choose_all = quickElement('a', choose_all_wrap, gettext('Choose all') + " ", 'title', interpolate(gettext('Click to choose all %s at once.'), [field_name]), 'href', 'javascript: (function(){ SelectBox.move_all("' + field_id + '_from", "' + field_id + '_to"); SelectFilter.refresh_icons("' + field_id + '");})()', 'id', field_id + '_add_all_link');
        choose_all.className = 'selector-chooseall';
        var arrow_right = quickElement('span', choose_all, '');
        arrow_right.className = 'glyphicon glyphicon-circle-arrow-right';
        ...
        var choose_all_wrap = quickElement('div', selector_chosen, "");
        choose_all_wrap.className = 'selector-choose-wrap';
        var clear_all = quickElement('a', choose_all_wrap, " " + gettext('Remove all'), 'title', interpolate(gettext('Click to remove all chosen %s at once.'), [field_name]), 'href', 'javascript: (function() { SelectBox.move_all("' + field_id + '_to", "' + field_id + '_from"); SelectFilter.refresh_icons("' + field_id + '");})()', 'id', field_id + '_remove_all_link');
        clear_all.className = 'selector-clearall';
        var arrow_left = document.createElement('span');
        arrow_left.className = 'glyphicon glyphicon-circle-arrow-left';
        clear_all.insertBefore(arrow_left, clear_all.firstChild);
