...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'qa_category', 'parent_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'qa_category', 'parent',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['qa.Category'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        u'qa.category': {
            ...
            'parent': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['qa.Category']", 'null': 'True', 'blank': 'True'})
        },
        u'qa.degree': {
