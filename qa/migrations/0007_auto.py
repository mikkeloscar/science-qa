...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'qa_category_parents')
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'qa_category_parents'))
    ...
    models = {
        u'qa.category': {
            ...
            'parents': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['qa.Category']", 'null': 'True', 'blank': 'True'})
        },
        u'qa.degree': {
